...
public class CadastroCidadeService {
	...
	public List<Cidade> buscarPorNome(String nomeCidade) {
		return cidadeRepository.consultarPorNome(nomeCidade);
	}
	
	public Cidade buscarPorNomeEstado(String nomeCidade, Long estadoId) {
		return cidadeRepository.consultarPorNomeEstadoId(nomeCidade, estadoId);
	}

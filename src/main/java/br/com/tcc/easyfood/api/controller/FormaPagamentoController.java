...
import br.com.tcc.easyfood.api.assembler.FormaPagamentoInputDisassembler;
...
import br.com.tcc.easyfood.domain.repository.FormaPagamentoRepository;
import br.com.tcc.easyfood.domain.service.CadastroFormaPagamentoService;
...
public class FormaPagamentoController {
	...
	private FormaPagamentoInputDisassembler formaPagamentoInputDisassembler;
	 ...
	 @GetMapping public List<FormaPagamentoModel> listar() { 
	...
	/*
	 * // Implementação usando somente ShallowEtags
	 * 
	 * @GetMapping public ResponseEntity<List<FormaPagamentoModel>> listar() {
	 ...
	 * 
	 * return ResponseEntity.ok() // .cacheControl(CacheControl.maxAge(10,
	 * TimeUnit.SECONDS)) // .cacheControl(CacheControl.maxAge(10,
	 * TimeUnit.SECONDS).cachePrivate()) .cacheControl(CacheControl.maxAge(10,
	 * TimeUnit.SECONDS).cachePublic()) // .cacheControl(CacheControl.noCache()) //
	 * .cacheControl(CacheControl.noStore()) .body(formasPagamentosModel); }
	 */

	// Implementação usando Deep Etags
	/*@GetMapping
	...
	/*
	 * @GetMapping("/{formaPagamentoId}") public ResponseEntity<FormaPagamentoModel>
	 * buscar(@PathVariable Long formaPagamentoId) { FormaPagamento formaPagamento =
	 ...
	 * 
	 * return ResponseEntity.ok() .cacheControl(CacheControl.maxAge(10,
	 * TimeUnit.SECONDS)) .body(formaPagamentoModel); }
	 */
	...
	public ResponseEntity<FormaPagamentoModel> buscar(@PathVariable Long formaPagamentoId, ServletWebRequest request) {
	 ...
	 @GetMapping("/{formaPagamentoId}") public FormaPagamentoModel
	 buscar(@PathVariable Long formaPagamentoId) { 
		 FormaPagamento formaPagamento = cadastroFormaPagamento.buscarOuFalhar(formaPagamentoId);
